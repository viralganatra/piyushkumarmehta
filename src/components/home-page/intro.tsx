...
import MainImageLegacy1200 from '../../assets/images/bg-intro-faded-1200w.jpg';
import MainImageModern1200 from '../../assets/images/bg-intro-faded-1200w.webp';
import MainImageLegacy1560 from '../../assets/images/bg-intro-faded-1560w.jpg';
import MainImageModern1560 from '../../assets/images/bg-intro-faded-1560w.webp';
import MainImageLegacy800 from '../../assets/images/bg-intro-faded-800w.jpg';
import MainImageModern800 from '../../assets/images/bg-intro-faded-800w.webp';
import type { RefProps } from '../../types/refs';
...
export function HomePageIntro({ aboutSectionRef, contactSectionRef }: RefProps) {
  return (
    <Section>
      <Masthead>
        <picture>
