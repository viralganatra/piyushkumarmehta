...
import HandHoldingLegacy450 from '../../assets/images/hand-holding-450w.jpg';
import HandHoldingModern450 from '../../assets/images/hand-holding-450w.webp';
import HandHoldingLegacy600 from '../../assets/images/hand-holding-600w.jpg';
import HandHoldingModern600 from '../../assets/images/hand-holding-600w.webp';
import HandHoldingLegacy900 from '../../assets/images/hand-holding-900w.jpg';
import HandHoldingModern900 from '../../assets/images/hand-holding-900w.webp';
import PortraitLegacy450 from '../../assets/images/piyushbhai-450w.jpg';
import PortraitModern450 from '../../assets/images/piyushbhai-450w.webp';
import PortraitLegacy600 from '../../assets/images/piyushbhai-600w.jpg';
import PortraitModern600 from '../../assets/images/piyushbhai-600w.webp';
import PortraitLegacy900 from '../../assets/images/piyushbhai-900w.jpg';
import PortraitModern900 from '../../assets/images/piyushbhai-900w.webp';
...
import { clearfix, constrainLayout, EmphasisedText, px2rem } from '../../utils/styles';
...
type RefPropsContact = Pick<RefProps, 'contactSectionRef'> & {
  isError?: boolean;
};

export const HomePageAbout = forwardRef<HTMLElement, RefPropsContact>(function About(
  { isError, contactSectionRef },
  ref,
) {
  return (
    <section ref={ref}>
      <ConstrainedLayout>
        ...
        <MainText>
          {isError ? (
            <Fragment>
              <EmphasisedText>Error - Page Not Found</EmphasisedText>
              <WelcomeText>Sorry, unable to find the page you were looking for.</WelcomeText>
            </Fragment>
          ) : (
            <Fragment>
              <EmphasisedText>Jai Shree Krishna,</EmphasisedText>
              <WelcomeText>
                I&apos;m Piyushbhai Mehta and I perform Hindu wedding ceremonies at both intimate
                and grand scales. I focus on creating a spiritual atmosphere through silent
                ceremonies, ensuring that you are connected with the divine energy whilst engaging
                your wedding guests and loved ones in your auspicious ceremony.
              </WelcomeText>
            </Fragment>
          )}
          ...
          <ConstrainedLayout>
            <RecitingContent>
              ...
              <RecitingText>
                ...
                <p>
                  Having performed Hindu wedding ceremonies across a range of destinations within
                  and outside of the UK, I adhere to maintain the values and authenticity of such a
                  revered ritual in a time-effective, organised and devotional manner, ensuring it
                  is a day that will remain forever in your hearts.
                </p>
              </RecitingText>
            </RecitingContent>
          </ConstrainedLayout>
